...
if not ... then require'thirdparty.libcurl.libcurl_test'; return end

local ffi = require'ffi'
local bit = require'bit'
require'thirdparty.libcurl.libcurl_h'

--local C = ffi.load'curl'

-- Modded for Mojave:
-- Use the correct version of libcurl based on OS
local libPath = love.filesystem.getSaveDirectory() .. "/"
local libName = {
    ["OS X"] = libPath .. "libcurl.dylib",
    ["Windows"] = libPath .. "libcurl.dll",
    ["Linux"] = "curl"
}
local C = ffi.load(libName[love.system.getOS()])
